// I found that great tool for format data in ascii table here
// https://github.com/khalidabuhakmeh/ConsoleTables/blob/master/src/ConsoleTables/ConsoleTable.cs
// Thanks to Khalid Abuhakmeh https://github.com/khalidabuhakmeh
//
// Because I want to core library without any depedencies
// I have integreted the code here
//
// ---------
using System;
...
namespace ConsoleTables
{
    public class ConsoleTable
    {
        ...
        public ConsoleTable AddRow2(object[] values)
        {
            if (values == null)
                throw new ArgumentNullException(nameof(values));
